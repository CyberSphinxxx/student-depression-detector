...
# Drop Work Pressure and Job Satisfaction to match 11-feature model
cols_to_drop = [c for c in ['Work Pressure', 'Job Satisfaction'] if c in df.columns]
if cols_to_drop:
...
stress_cols = [c for c in ['Academic Pressure', 'Financial Stress'] if c in df.columns]
if stress_cols:
