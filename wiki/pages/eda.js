      ...
      <div className="space-y-6 animate-in fade-in duration-500">
        ...
        <CollapsibleSection title="Key Observations" defaultOpen={true}>
          <ol className="list-decimal pl-5 space-y-3 text-foreground/80">
            ...
            <li><strong className="text-foreground">Suicidal Thoughts is the biggest contributor</strong> — Students with a history of suicidal ideation are overwhelmingly more likely to be classified as depressed. It serves as the strongest overall predictor of depression.</li>
            <li><strong className="text-foreground">Academic Pressure is the strongest numeric predictor</strong> — Students who rated it 4 or 5 out of 5 are significantly more likely to be depressed. Its correlation with depression is 0.47, the highest among all numeric features.</li>
            <li><strong className="text-foreground">Financial Stress is the second strongest numeric predictor</strong> — Level 4 and 5 stress shows a correlation of 0.36 with depression, highlighting socioeconomic factors.</li>
